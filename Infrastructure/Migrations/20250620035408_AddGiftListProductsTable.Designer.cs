...
namespace BienComun.Infrastructure.Migrations
{
    ...
    [Migration("20250620035408_AddGiftListProductsTable")]
    partial class AddGiftListProductsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BienComun.Core.Entities.Contribution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("GiftListProductId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BienComun.Core.Entities.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BienComun.Core.Entities.Contribution", b =>
                {
                    b.HasOne("BienComun.Core.Entities.GiftListProduct", "GiftListProduct")
                        .WithMany("Contributions")
                        .HasForeignKey("GiftListProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GiftListProduct");
                });
